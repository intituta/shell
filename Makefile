...
#    Updated: 2022/04/27 09:52:35 by kferterb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MOD_DIR		=	libft_mod/
BUILDIN		=	buildin/
SRC			=	$(addprefix $(SRC_DIR), main.c ft_signals.c ft_preparsing.c ft_preparsing_utils.c ft_parsing.c ft_parsing_quotes.c ft_parse_redirects.c ft_parse_pipes.c ft_parse_dollar.c ft_history.c ft_history_utils.c ft_free.c ft_exe.c ft_exe_utils.c)\
